...
metadata_re_kim = metadata %>% 
  right_join(unweighted_kim, by = c("SampleID" = "X1")) %>% 
               dplyr::select(1:40)
metadata_re_herman = metadata %>% 
  right_join(unweighted_herman, by = c("SampleID" = "X1")) %>% 
               dplyr::select(1:40)
metadata_re_levin = metadata %>% 
  right_join(unweighted_levin, by = c("SampleID" = "X1")) %>% 
               dplyr::select(1:40)
metadata_re_robinson = metadata %>% 
  right_join(unweighted_robinson, by = c("SampleID" = "X1")) %>% 
               dplyr::select(1:40)
metadata_re_planer = metadata %>% 
  right_join(unweighted_planer, by = c("SampleID" = "X1")) %>% 
               dplyr::select(1:40)
metadata_re_levin = metadata %>% 
  right_join(unweighted_levin, by = c("SampleID" = "X1")) %>% 
               dplyr::select(1:40)
metadata_re_db = metadata %>% 
  right_join(unweighted_db, by = c("SampleID" = "X1")) %>% 
               dplyr::select(1:40)
metadata_re_cioffi = metadata %>% 
  right_join(unweighted_cioffi, by = c("SampleID" = "X1")) %>% 
               dplyr::select(1:40)
metadata_re_chu = metadata %>% 
  right_join(unweighted_chu, by = c("SampleID" = "X1")) %>% 
               dplyr::select(1:40)
...
f01e_df2 = f01e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Faith's PD")
f01r_dw = dwplot(f01r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
  ...
  scale_y_discrete(labels = c("Asian/PI\n- Black",
                              "Asian/PI\n- White",
                              "Black\n- White"))
f01e_dw = dwplot(f01e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
o01e_df2 = o01e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Observed ASVs")
o01r_dw = dwplot(o01r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
o01e_dw = dwplot(o01e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
s01e_df2 = s01e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Shannon Diversity")
s01r_dw = dwplot(s01r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
s01e_dw = dwplot(s01e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
p01e_df2 = p01e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Pielou's Evenness")
p01r_dw = dwplot(p01r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
p01e_dw = dwplot(p01e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
c01e_df2 = c01e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Chao 1") 
c01r_dw = dwplot(c01r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
  ...
  scale_color_manual(name = "Metric", values = c("#873eff"),
                     labels = c("Chao 1"))
c01e_dw = dwplot(c01e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
f16e_df2 = f16e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Faith's PD")
f16r_dw = dwplot(f16r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
  ...
  scale_y_discrete(labels = c("Asian/PI\n- Black", 
                              "Asian/PI\n- White", 
                              "Black\n- White"))
f16e_dw = dwplot(f16e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
o16e_df2 = o16e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Observed ASVs")
o16r_dw = dwplot(o16r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
  ...
  scale_color_manual(name = "Metric", 
                                        values = c("#4a228c"),
                                        labels = c("Observed ASVs"))
o16e_dw = dwplot(o16e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
s16e_df2 = s16e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Shannon Diversity")
s16r_dw = dwplot(s16r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
 ...
 scale_color_manual(name = "Metric", values = c("#834600"),
                                        labels = c("Shannon Diversity"))
s16e_dw = dwplot(s16e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
p16e_df2 = p16e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Pielou's Evenness")
p16r_dw = dwplot(p16r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
  ...
  scale_color_manual(name = "Metric", 
                                        values = c("#b05b00"),
                                        labels = c("Pielou's Evenness"))
p16e_dw = dwplot(p16e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
c16e_df2 = c16e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Chao 1") 
c16r_dw = dwplot(c16r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
  ...
  scale_color_manual(name = "Metric", values = c("#873eff"),
                     labels = c("Chao 1"))
c16e_dw = dwplot(c16e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
f63e_df2 = f63e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Faith's PD")
f63r_dw = dwplot(f63r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
...
f63e_dw = dwplot(f63e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
o63e_df2 = o63e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Observed ASVs")
o63r_dw = dwplot(o63r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
o63e_dw = dwplot(o63e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
s63e_df2 = s63e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Shannon Diversity")
s63r_dw = dwplot(s63r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
s63e_dw = dwplot(s63e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
p63e_df2 = p63e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Pielou's Evenness")
p63r_dw = dwplot(p63r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
p63e_dw = dwplot(p63e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
c63e_df2 = c63e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Chao 1") 
c63r_dw = dwplot(c63r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
c63e_dw = dwplot(c63e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
f312e_df2 = f312e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Faith's PD")
f312r_dw = dwplot(f312r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  ggtitle("3-12 months") + 
...
f312e_dw = dwplot(f312e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
o312e_df2 = o312e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Observed ASVs")
o312r_dw = dwplot(o312r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
o312e_dw = dwplot(o312e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
s312e_df2 = s312e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Shannon Diversity")
s312r_dw = dwplot(s312r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
s312e_dw = dwplot(s312e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
p312e_df2 = p312e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Pielou's Evenness")
p312r_dw = dwplot(p312r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
p312e_dw = dwplot(p312e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
c312e_df2 = c312e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Chao 1") 
c312r_dw = dwplot(c312r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
c312e_dw = dwplot(c312e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
f13e_df2 = f13e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Faith's PD")
f13r_dw = dwplot(f13r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  ggtitle("1-3 years") + 
...
f13e_dw = dwplot(f13e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
o13e_df2 = o13e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Observed ASVs")
o13r_dw = dwplot(o13r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
o13e_dw = dwplot(o13e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
s13e_df2 = s13e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Shannon Diversity")
s13r_dw = dwplot(s13r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
 ...
 scale_color_manual(name = "Metric", values = c("#834600"),
  ...
  annotate(geom = "richtext", fill = NA, label.color = NA,
           ...
           x = -Inf, y = Inf, size = 6,
           hjust = 0, vjust = 1, color = "blue1")
s13e_dw = dwplot(s13e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
p13e_df2 = p13e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Pielou's Evenness")
p13r_dw = dwplot(p13r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
p13e_dw = dwplot(p13e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
c13e_df2 = c13e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Chao 1") 
c13r_dw = dwplot(c13r_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
c13e_dw = dwplot(c13e_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
f312ye_df2 = f312ye_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Faith's PD")
f312yr_dw = dwplot(f312yr_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
  ...
  scale_y_discrete(labels = c("Asian/PI\n- Black", 
                              "Asian/PI\n- White", 
                              "Black\n- White"))
f312ye_dw = dwplot(f312ye_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
o312ye_df2 = o312ye_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Observed ASVs")
o312yr_dw = dwplot(o312yr_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
  ...
  scale_color_manual(name = "Metric", 
                                        values = c("#4a228c"),
                                        labels = c("Observed ASVs"))
o312ye_dw = dwplot(o312ye_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
s312ye_df2 = s312ye_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Shannon Diversity")
s312yr_dw = dwplot(s312yr_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
 ...
 scale_color_manual(name = "Metric", values = c("#834600"),
                                        labels = c("Shannon Diversity"))
s312ye_dw = dwplot(s312ye_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
p312ye_df2 = p312ye_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Pielou's Evenness")
p312yr_dw = dwplot(p312yr_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
  ...
  scale_color_manual(name = "Metric", 
                                        values = c("#b05b00"),
                                        labels = c("Pielou's Evenness"))
p312ye_dw = dwplot(p312ye_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
c312ye_df2 = c312ye_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "Chao 1") 
c312yr_dw = dwplot(c312yr_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
  ...
  scale_color_manual(name = "Metric", values = c("#873eff"),
                     labels = c("Chao 1"))
c312ye_dw = dwplot(c312ye_df2, vline = geom_vline(xintercept = 0, color = "darkgrey",
                                    linetype = 2),
       dot_args = list(aes(color = "model", size=3)),
       whisker_args = list(aes(color = "model", size=2))) +
  theme_classic() + 
...
plot_B.fragilis = ggplot(species_meta,
  ...
  stat_compare_means(label = "p.signif", 
                     bracket.size = 0.6, size = 6, 
                     comparisons = list(c("White", "Asian/Pacific Islander")),
                     symnum.args = list(cutpoints = 
                                          c(0, 0.001, 
                                            0.4, 0.9, 1),
                                        symbols = c("***", "**", "*",
...
tiff(file="fig1v4.tif", res=300, width=27, height=28, units="in")
row1 = plot_grid(alpha_all_age_graph, weight_age + theme(legend.position = "none"),
                 nrow = 1, ncol = 2,
                 rel_widths = c(2, 1.2), labels = c("A", ""),
                 label_size = 24)
top = plot_grid(row1, age_legend, nrow = 2, ncol = 1, 
                rel_heights = c(1, 0.2))

row3_left = plot_grid(f63r_dw, o63r_dw, c63r_dw, s63r_dw, p63r_dw,
                      f63e_dw, o63e_dw, c63e_dw, s63e_dw, p63e_dw,
                      nrow = 2, ncol = 5, rel_heights = c(2,1), align = "hv",
                      axis = "ltb")
row4_left = plot_grid(f312r_dw, o312r_dw, c312r_dw, s312r_dw, p312r_dw,
                      f312e_dw, o312e_dw, c312e_dw, s312e_dw, p312e_dw,
                      nrow = 2, ncol = 5, rel_heights = c(2,1), align = "hv",
                      axis = "ltb")
row5_left = plot_grid(f13r_dw, o13r_dw, c13r_dw, s13r_dw, p13r_dw,
                      f13e_dw, o13e_dw, c13e_dw, s13e_dw, p13e_dw,
                      nrow = 2, ncol = 5, rel_heights = c(2,1), align = "hv",
                      axis = "ltb")

bottom = plot_grid(row3_left, 
                   ...
                   combo_legend, nmds_legend,
                 nrow = 4, ncol = 2,
                 rel_heights = c(1,1,1,.2), rel_widths = c(2, 1.2),
                 axis = "lb", align = "hv",
                 labels = c("B", "", "C", "", "D", "", "", ""), label_size = 24)
...
setEPS()
postscript(file="fig1v4.eps", width=28, height=30, paper = "special")
plot
dev.off()
```
...
```{r fig2c}
tiff(file="fig2c.tif", 
     res=300, width=18, height=10, units="in")
plot2c = plot_grid(plot_OD1, plot_Enterobacteriaceae, 
          plot_Bifidobacterium, plot_Blautia, 
          plot_B.fragilis, plot_C.ramosum, 
          plot_C.aerofaciens, plot_P.copri,
          plot_R.gnavus, plot_V.dispar,
          nrow = 2, ncol = 5,
          axis = "tb", align = "hv")
plot2c
dev.off()
...
setEPS()
postscript(file="fig2c.eps", width=17, height=9, paper = "special")
plot2c
dev.off()
```
