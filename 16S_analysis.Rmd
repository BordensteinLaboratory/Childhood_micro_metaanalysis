...
mds_otus_weighted_points2_age_012month = mds_otus_weighted_points2_age2 %>% 
  filter(Host_age_cat_new2 == "0-3 months" | Host_age_cat_new2 == "3-12 months")
...
faithr_df$model = factor(faithr_df$model, levels = c("0-3 months", "3-12 months", "1-3 years")) 
shannonr_df = rbind(s1m3mr_df3, s312r_df3, s13r_df3)
shannonr_df$model = factor(shannonr_df$model, levels = c("0-3 months", "3-12 months", "1-3 years")) 
pielour_df = rbind(p1m3mr_df3, p312r_df3, p13r_df3)
pielour_df$model = factor(pielour_df$model, levels = c("0-3 months", "3-12 months", "1-3 years")) 
observedr_df = rbind(o1m3mr_df3, o312r_df3, o13r_df3)
observedr_df$model = factor(observedr_df$model, levels = c("0-3 months", "3-12 months", "1-3 years")) 
chaor_df = rbind(c1m3mr_df3, c312r_df3, c13r_df3)
chaor_df$model = factor(chaor_df$model, levels = c("0-3 months", "3-12 months", "1-3 years")) 
...
faithe_df$model = factor(faithe_df$model, levels = c("0-3 months", "3-12 months", "1-3 years")) 
shannone_df = rbind(s1m3me_df3, s312e_df3, s13e_df3)
shannone_df$model = factor(shannone_df$model, levels = c("0-3 months", "3-12 months", "1-3 years")) 
pieloue_df = rbind(p1m3me_df3, p312e_df3, p13e_df3)
pieloue_df$model = factor(pieloue_df$model, levels = c("0-3 months", "3-12 months", "1-3 years")) 
observede_df = rbind(o1m3me_df3, o312e_df3, o13e_df3)
observede_df$model = factor(observede_df$model, levels = c("0-3 months", "3-12 months", "1-3 years")) 
chaoe_df = rbind(c1m3me_df3, c312e_df3, c13e_df3) 
chaoe_df$model = factor(chaoe_df$model, levels = c("0-3 months", "3-12 months", "1-3 years")) 
...
chaoe_dw = dwplot(chaoe_df, vline = geom_vline(xintercept = 0, color = "gray40",
  ...
  scale_y_discrete(labels = c("Non Hispanic\n- Hispanic")) +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "0-3 months: p = 0.977<br>
           3-12 months: p = 0.668<br>
...
shannone_dw = dwplot(shannone_df, vline = geom_vline(xintercept = 0, color = "gray40",
  ...
  scale_y_discrete(labels = c("Non Hispanic\n- Hispanic")) +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "0-3 months: p = 0.839<br>
           3-12 months: p = 0.406<br>
...
pieloue_dw = dwplot(pieloue_df, vline = geom_vline(xintercept = 0, color = "gray40",
  ...
  scale_y_discrete(labels = c("Non Hispanic\n- Hispanic")) +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "0-3 months: p = 0.548<br>
           3-12 months: p = 0.815<br>
           1-3 years: p = 0.174", 
           x = Inf, y = -Inf, size = 6,
           hjust = 1, vjust = 0)

pielour_df$model = factor(pielour_df$model, levels = c("0-3 months",
                                                       "3-12 months",
                                                       "1-3 years"))
