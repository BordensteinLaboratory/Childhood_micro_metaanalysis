...
weight_race <- ggplot(mds_otus_weighted_points2, 
                      aes(x = MDS1, y = MDS2, color = Race, 
                          shape = Ethnicity)) +
  geom_point(size=3) + scale_color_manual(values = c("#377eb8", "#ffff33", "#e41a1c")) +
...
weight_race_one <- ggplot(mds_otus_weighted_one_points2, 
  ...
  stat_ellipse(aes(x = MDS1, y = MDS2, group = Race, 
               ...
               type = "t", level = 0.95) +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Race: p = 0.164, R<sup>2</sup> = 3.0%<br>
           Ethnicity: p = 0.674, R<sup>2</sup> = 1.5%<br>
           Age: p = 0.638, R<sup>2</sup> = 1.4%<br>
           Sex: p = 0.318, R<sup>2</sup> = 0.2%<br>
           Delivery mode: p = 0.204, R<sup>2</sup> = 0.3%<br>
           Infant diet: p = 0.628, R<sup>2</sup> = 0.6%", 
           x = -Inf, y = -Inf, size = 5,
           hjust = 0, vjust = 0)
...
unweight_race_one <- ggplot(mds_otus_unweighted_one_points2, 
  ...
  stat_ellipse(aes(x = MDS1, y = MDS2, group = Race, 
               ...
               type = "t", level = 0.95) +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "Race: p = 0.160, R<sup>2</sup> = 3.8%<br>
           <b>Ethnicity: p = 0.010, R<sup>2</sup> = 2.2%</b><br>
           Age: p = 0.508, R<sup>2</sup> = 1.8%<br>
           Sex: p = 0.342, R<sup>2</sup> = 0.2%<br>
           <b>Delivery mode: p = 0.024, R<sup>2</sup> = 0.3%<br>
           Infant diet: p = 0.026, R<sup>2</sup> = 1.1%", 
           x = -Inf, y = -Inf, size = 5,
           hjust = 0, vjust = 0)
...
bact_race = ggboxplot(phyla_meta, x = "Race", 
                  ...
                  palette = c("#377eb8", "#ffff33", "#e41a1c"), 
                 add = "jitter", 
                  add.params = list(fill = "white"), 
                  ylab = "Bacteroidetes") 
...
```{r pub_graphs}
tiff(file="fig1.tif", res=300, width=20, height=16, units="in")
legend1 = get_legend(plot1_alpha + theme(legend.box.margin = margin(0, 0, 0, 12)))
legend2 = get_legend(plot1_alphae + theme(legend.box.margin = margin(0, 0, 0, 12)))
legends = plot_grid(legend1, legend2, nrow = 2, ncol = 1,
                    align = "hv")
left = plot_grid(unweight_race + theme(legend.position = "none"),
                 weight_race + theme(legend.position = "none"),
                 nrow = 2, ncol = 1, labels = c('A'), 
                 label_size = 20, align = "v")
right_row1 = plot_grid(plot3_alpha + theme(legend.position = "none"),
                      plot2_alpha + theme(legend.position = "none"),
                      plot3_alphae + theme(legend.position = "none"),
                      plot2_alphae + theme(legend.position = "none"),
                 nrow = 2, ncol = 2, labels = c('B'), 
                 label_size = 20, align = "hv") 
right_row2 = plot_grid(bact_race + theme(legend.position = "none"),
                      prot_race + theme(legend.position = "none"),
                      tene_race + theme(legend.position = "none"),
                      verr_race + theme(legend.position = "none"),
                      acti_eth + theme(legend.position = "none"),
                      prot_eth + theme(legend.position = "none"),
                      tene_eth + theme(legend.position = "none"),
                      legends,
                 nrow = 2, ncol = 4, labels = c('C'), 
                 label_size = 20, align = "hv") 
right = plot_grid(right_row1, right_row2, nrow = 2, ncol = 1, 
          rel_widths = c(1.5, 1.5, 0.75), align = "v", axis = "l")
plot = plot_grid(left, right, nrow = 1, ncol = 2, 
          rel_widths = c(1.5, 2), axis = "tb", align = "hv")
plot
dev.off()

setEPS()
postscript(file="fig1.eps", width=20, height=16, paper = "special")
plot
dev.off()
```