...
mds_otus_weighted_points2_age$Host_age_cat_new2 = factor(mds_otus_weighted_points2_age$Host_age_cat_new2, 
                                    levels = c("0-3 months", "3-12 months", "1-3 years", "3-12 years"))
...
mds_otus_weighted_points2_age_03month = mds_otus_weighted_points2_age %>% 
  filter(Host_age_cat_new2 == "0-3 months")
...
mds_otus_weighted_points2_age_012month = mds_otus_weighted_points2_age %>% 
  filter(Host_age_cat_new2 == "0-3 months" | Host_age_cat_new == "3-12 months")
...
###Combo
f63r_df3 = f63r_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "6 weeks - 3 months")
o63r_df3 = o63r_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "6 weeks - 3 months")
s63r_df3 = s63r_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "6 weeks - 3 months")
p63r_df3 = p63r_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "6 weeks - 3 months")
c63r_df3 = c63r_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "6 weeks - 3 months")

f312r_df3 = f312r_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "3-12 months")
...
faithr_df = rbind(f63r_df3, f312r_df3, f13r_df3)
faithr_df$model = factor(faithr_df$model, levels = c("6 weeks - 3 months", "3-12 months", "1-3 years")) 
shannonr_df = rbind(s63r_df3, s312r_df3, s13r_df3)
shannonr_df$model = factor(shannonr_df$model, levels = c("6 weeks - 3 months", "3-12 months", "1-3 years")) 
pielour_df = rbind(p63r_df3, p312r_df3, p13r_df3)
pielour_df$model = factor(pielour_df$model, levels = c("6 weeks - 3 months", "3-12 months", "1-3 years")) 
observedr_df = rbind(o63r_df3, o312r_df3, o13r_df3)
observedr_df$model = factor(observedr_df$model, levels = c("6 weeks - 3 months", "3-12 months", "1-3 years")) 
chaor_df = rbind(c63r_df3, c312r_df3, c13r_df3)
chaor_df$model = factor(chaor_df$model, levels = c("6 weeks - 3 months", "3-12 months", "1-3 years")) 
...
faithr_dw = dwplot(faithr_df, vline = geom_vline(xintercept = 0, color = "gray40",
  ...
  scale_y_discrete(labels = c("Asian/PI\n- Black", 
                              ...
                              "Black\n- White")) +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "6 weeks-3 months: p = 0.374<br>
           3-12 months: p = 0.233<br>
           <span style='color: blue1;'><b><i>1-3 years: p = 0.006</b></i></span>", 
           x = Inf, y = -Inf, size = 6,
           hjust = 1, vjust = 0)
...
observedr_dw = dwplot(observedr_df, vline = geom_vline(xintercept = 0, color = "gray40",
  ...
  scale_y_discrete(labels = c("Asian/PI\n- Black", 
                              ...
                              "Black\n- White")) +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "6 weeks-3 months: p = 0.209<br>
           <span style='color: blue1;'><b><i>3-12 months: p = 0.005<br>
           1-3 years: p = 0.001</b></i></span>", 
           x = Inf, y = -Inf, size = 6,
           hjust = 1, vjust = 0)
...
chaor_dw = dwplot(chaor_df, vline = geom_vline(xintercept = 0, color = "gray40",
  ...
  scale_y_discrete(labels = c("Asian/PI\n- Black", 
                              ...
                              "Black\n- White")) +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "6 weeks-3 months: p = 0.186<br>
           <span style='color: blue1;'><b><i>3-12 months: p = 0.001<br>
           1-3 years: p = 0.002</b></i></span>", 
           x = Inf, y = -Inf, size = 6,
           hjust = 1, vjust = 0)
...
shannonr_dw = dwplot(shannonr_df, vline = geom_vline(xintercept = 0, color = "gray40",
  ...
  scale_y_discrete(labels = c("Asian/PI\n- Black", 
                              ...
                              "Black\n- White")) +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "6 weeks-3 months: p = 0.682<br>
           <span style='color: blue1;'><b><i>3-12 months: p = 0.006<br>
           1-3 years: p = 0.020</b></i></span>", 
           x = Inf, y = -Inf, size = 6,
           hjust = 1, vjust = 0)
...
pielour_dw = dwplot(pielour_df, vline = geom_vline(xintercept = 0, color = "gray40",
  ...
  scale_y_discrete(labels = c("Asian/PI\n- Black", 
                              ...
                              "Black\n- White")) +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "6 weeks-3 months: p = 0.746<br>
           <span style='color: blue1;'><b><i>3-12 months: p = 0.026</b></i><br></span>
           1-3 years: p = 0.142", 
           x = Inf, y = -Inf, size = 6,
           hjust = 1, vjust = 0)

f63e_df3 = f63e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "6 weeks - 3 months")
o63e_df3 = o63e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "6 weeks - 3 months")
s63e_df3 = s63e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "6 weeks - 3 months")
p63e_df3 = p63e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "6 weeks - 3 months")
c63e_df3 = c63e_df %>% dplyr::select(contrast:adj.p.value) %>% 
  rename(term = contrast) %>% rename(p.value = adj.p.value) %>% 
  mutate(model = "6 weeks - 3 months")
...
faithe_df = rbind(f63e_df3, f312e_df3, f13e_df3)
faithe_df$model = factor(faithe_df$model, levels = c("6 weeks - 3 months", "3-12 months", "1-3 years")) 
shannone_df = rbind(s63e_df3, s312e_df3, s13e_df3)
shannone_df$model = factor(shannone_df$model, levels = c("6 weeks - 3 months", "3-12 months", "1-3 years")) 
pieloue_df = rbind(p63e_df3, p312e_df3, p13e_df3)
pieloue_df$model = factor(pieloue_df$model, levels = c("6 weeks - 3 months", "3-12 months", "1-3 years")) 
observede_df = rbind(o63e_df3, o312e_df3, o13e_df3)
observede_df$model = factor(observede_df$model, levels = c("6 weeks - 3 months", "3-12 months", "1-3 years")) 
chaoe_df = rbind(c63e_df3, c312e_df3, c13e_df3) 
chaoe_df$model = factor(chaoe_df$model, levels = c("6 weeks - 3 months", "3-12 months", "1-3 years")) 
...
faithe_dw = dwplot(faithe_df, vline = geom_vline(xintercept = 0, color = "gray40",
  ...
  scale_y_discrete(labels = c("Non Hispanic\n- Hispanic")) +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "6 weeks-3 months: p = 0.758<br>
           3-12 months: p = 0.880<br>
           <span style='color: blue1;'><b><i>1-3 years: p = 0.015</b></i></span>", 
           x = Inf, y = -Inf, size = 6,
           hjust = 1, vjust = 0)
...
observede_dw = dwplot(observede_df, vline = geom_vline(xintercept = 0, color = "gray40",
  ...
  scale_y_discrete(labels = c("Non Hispanic\n- Hispanic")) +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "6 weeks-3 months: p = 0.973<br>
           3-12 months: p = 0.914<br>
           <span style='color: blue1;'><b><i>1-3 years: p = 0.023</b></i></span>", 
           x = Inf, y = -Inf, size = 6,
           hjust = 1, vjust = 0)
...
chaoe_dw = dwplot(chaoe_df, vline = geom_vline(xintercept = 0, color = "gray40",
  ...
  scale_y_discrete(labels = c("Non Hispanic\n- Hispanic")) +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "6 weeks-3 months: p = 0.977<br>
           3-12 months: p = 0.945<br>
           <span style='color: blue1;'><b><i>1-3 years: p = 0.018</b></i></span>", 
           x = Inf, y = -Inf, size = 6,
           hjust = 1, vjust = 0)
...
shannone_dw = dwplot(shannone_df, vline = geom_vline(xintercept = 0, color = "gray40",
  ...
  scale_y_discrete(labels = c("Non Hispanic\n- Hispanic")) +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "6 weeks-3 months: p = 0.839<br>
           3-12 months: p = 0.857<br>
           <span style='color: blue1;'><b><i>1-3 years: p = 0.042</b></i></span>", 
           x = Inf, y = -Inf, size = 6,
           hjust = 1, vjust = 0)
...
pieloue_dw = dwplot(pieloue_df, vline = geom_vline(xintercept = 0, color = "gray40",
  ...
  scale_y_discrete(labels = c("Non Hispanic\n- Hispanic")) +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "6 weeks-3 months: p = 0.533<br>
           3-12 months: p = 0.815<br>
           1-3 years: p = 0.174", 
           x = Inf, y = -Inf, size = 6,
           hjust = 1, vjust = 0)

pielour_df$model = factor(pielour_df$model, levels = c("6 weeks - 3 months",
                                                       "3-12 months",
                                                       "1-3 years"))
...
row4 = plot_grid(weight_age_6week3month + 
...
plot_grid(roc_plot, roc_plot_eth, nrow = 2, ncol = 1,
...
top = plot_grid(weight_age_01week + theme(legend.position = "none"), 
                ...
                weight_age_03month + theme(legend.position = "none"), 
...
pooled_sens_spec %>% group_by(Race, specificity) %>% 
  ...
  scale_fill_manual(values = c("#377eb8", "#ffd92f", "#e41a1c"), 
                     labels = c("White", "Black", 
                                "Asian/Pacific Islander")) +
  annotate(geom = "richtext", fill = NA, label.color = NA,
           label = "White, AUC = 0.898<br>
           Black, AUC = 0.925<br>
           Asian/Pacific Islander, AUC = 0.905", 
           x = Inf, y = -Inf, size = 3,
           hjust = 1, vjust = 0) + 
  geom_segment(aes(x = 0, y = 0, xend = 1, yend = 1),
...
get_roc_auc_black = function(model_num) {
  ...
  response = rf %>% 
    dplyr::select(obs, Black) %>% 
    mutate(obs_binary = if_else(obs == "Black", 1, 0))
  roc = roc(response$obs_binary ~ response$Black)
  roc$auc[1]
...
get_roc_auc_white = function(model_num) {
  rf = child_ml_results[[model_num]]$trained_model$pred 
  response = rf %>% 
    dplyr::select(obs, White) %>% 
    mutate(obs_binary = if_else(obs == "White", 1, 0))
  roc = roc(response$obs_binary ~ response$White)
  roc$auc[1]
...
get_roc_auc_aapi = function(model_num) {
  rf = child_ml_results[[model_num]]$trained_model$pred 
  response = rf %>% 
    dplyr::select(obs, AAPI) %>% 
    mutate(obs_binary = if_else(obs == "AAPI", 1, 0))
  roc = roc(response$obs_binary ~ response$AAPI)
  roc$auc[1]
...
response_black = rf %>% dplyr::select(obs, Black) %>% 
  mutate(obs_binary = if_else(obs == "Black", 1, 0))
...
Black = roc(response_black$obs_binary ~ response_black$Black)
