...
alpha_all_age_graph = ggplot(alpha_all_age_filtered,
  ...
  stat_compare_means(label = "p.signif", 
                     bracket.size = 0.7, size = 6,
                     comparisons = list(c("1-6 weeks", "3-12 months"),
                                        c("1-6 weeks", "1-3 years"),
                                        c("1-6 weeks", "3-12 years"),
                                        c("6 weeks-3 months", "3-12 months"),
                                        c("6 weeks-3 months", "1-3 years"),
                                        c("6 weeks-3 months", "3-12 years"),
                                        c("3-12 months", "1-3 years"),
                                        c("3-12 months", "3-12 years")),
                     symnum.args = list(cutpoints = 
                                          c(0, 0.001, 
                                            0.4, 0.5, 1),
                                        symbols = c("***", "**", "*",
