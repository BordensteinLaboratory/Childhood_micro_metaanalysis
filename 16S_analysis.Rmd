...
tiff(file="figs7.tif", res=300, width=12, height=24, units="in")
...
setEPS()
postscript(file="figs7.eps", width=12, height=24, paper = "special")
plot
dev.off()
```
...
tiff(file="figs8.tif", res=300, width=18, height=24, units="in")
...
setEPS()
postscript(file="figs8.eps", width=18, height=24, paper = "special")
plot
dev.off()
```
...
setEPS()
postscript(file="figs10.eps", width=20, height=16, paper = "special")
plots15
dev.off()
```
...
tiff(file="figs14.tif", res=300, width=20, height=6, units="in")
...
setEPS()
postscript(file="figs14.eps", width=20, height=6, paper = "special")
plot
dev.off()
```
...
#### Figure S20
```{r figure_s20}
tiff(file="figS20.tif", 
     res=300, width=10, height=6, units="in")
seq_depth_plot
dev.off()

setEPS()
postscript(file="figs20.eps", width=10, height=6, paper = "special")
seq_depth_plot
dev.off()
```
...
setEPS()
postscript(file="figs21a.eps", width=18, height=22, paper = "special")
...
setEPS()
postscript(file="figs21b.eps", width=18, height=19, paper = "special")
ggarrange(r36plot,
...
setEPS()
postscript(file="figs22a.eps", width=18, height=20, paper = "special")
...
setEPS()
postscript(file="figs22b.eps", width=18, height=20, paper = "special")
...
setEPS()
postscript(file="figS23.eps", width=15, height=9, paper = "special")
...
setEPS()
postscript(file="figs24.eps", width=12, height=9, paper = "special")
